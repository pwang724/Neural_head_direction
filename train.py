    ...
    def run_training(self, inputs, labels, opts):
        ...
        for ep in range(n_epoch):
            ...
            if (ep % 10000 == 0) and (ep >0):
                ...
                utils.pretty_plot([('Loss', loss)], col=2, row=2, save_name= loss_name)
